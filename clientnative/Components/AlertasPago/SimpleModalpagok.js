...
const SimpleModalpagok = (props) => {
  ...
  let closeModal = (bool, data) => {
    props.changeModalVisible60(bool);
    props.setData60(data);
  };
      ...
      <View style={styles.modal}>
        <View style={styles.textView}>
          ...
          <Text style={{ fontSize: 16, margin: 7 }}>
            ¡Pago realizado exitósamente!
          </Text>
        </View>
        <View style={styles.containerBtn}>
          <TouchableOpacity
            onPress={() => closeModal(false, "Aceptar")}
            onPressIn={() => navigation.navigate("ProfileUserScreen")}
...
export default SimpleModalpagok;
