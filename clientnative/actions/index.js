...
export const URL_PRICE_QUOTE = "http:/192.168.1.33:3001/api/calculatePrice";
export const URL_REQUEST_TRAVEL = "http://192.168.1.33:3001/api/requestTravel";
export const URL_TRAVEL = "http://192.168.1.33:3001/api/Travel";
export const URL_TRAVEL_ID = "http://192.168.1.33:3001/api/oneTravel";
  ...
  return async function (dispatch) {
    try {
      const response = await axios
        .post("http://192.168.1.33:3001/api/user", payload) //aca cada uno pone su ip
        .then((r) => {
          dispatch({
            type: "REGISTROO",
...
export function logiarUsuario(payload) {
  return async function (dispatch) {
    try {
      const response = await axios
        .post("http://192.168.1.33:3001/api/login", payload) //aca cada uno pone su ip
        .then((r) => {
          dispatch({
            type: "LOGEOO",
            payload: r.data.payload,
  ...
  return async function (dispatch) {
    try {
      const response = await axios.post(
        "http://192.168.1.33:3001/api/userProfile",
        payload
      );
...
export function completeProfileCarrier(payload) {
  return async function (dispatch) {
    try {
      const response = await axios.post(
        "http://192.168.1.33:3001/api/carrierProfile",
        payload
      );
      // console.log('Soy el console.log de response', response)
      return dispatch({
...
export function enviarToken(payload) {
  return async function (dispatch) {
    try {
      const response = await axios
        .post("http://192.168.1.33:3001/api/verifytoken", payload) //aca cada uno pone su ip
        .then((r) => {
...
export function changePassword(payload) {
  return async function (dispatch) {
    try {
      const response = await axios.post(
        "http://192.168.1.33:3001/api/changePassword",
        payload
      );
      // console.log('Soy el console.log de response', response)
      return dispatch({
